...
const DarkModeBtn: React.FC<darkModeBtnProps> = ({setDarkMode, darkMode}) => {
    return (
        <div className='absolute dark:text-white bottom-0 left-0 w-[100%] pb-4 pl-4 pt-2 flex items-center'>
